...
const ViewBlog=()=>{
    ...
    useEffect(()=>{
        const getCookie=async () =>{
            const {data }= await axios.get(`api/blogpost/cookieval`)
            setCookieName(data)
        }
           ...
           <h1 className="mt-4">{post.title}</h1> 
              ...
              <p className='lead'>
                    ...
                    <hr></hr>
                     ...
                     <p>
                     {/* Posted on {format(new Date(post.date), 'EEEE LLLL do, R')} */}
                     Posted on {post.date}
                   ...
                   <div className='card my-4'>
                        ...
                        <div className='card-body'>
                                ...
                                <div className='form-group'>
                                    <input type="text" placeholder={cookieName ? cookieName : "Enter Name"}  onChange={e=>setCommentName(e.target.value)} className='form-control' />
                                </div>
                                <div className="form-group">
